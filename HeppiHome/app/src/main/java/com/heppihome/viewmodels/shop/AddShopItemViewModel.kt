...
@HiltViewModel
class AddShopItemViewModel @Inject constructor(private val rep : HomeRepository) : ViewModel() {

    private val _name = MutableStateFlow("")
    private val _points = MutableStateFlow("1")
    ...
    fun addShopItem(context: Context) {
        viewModelScope.launch {
            rep.addItemToShop(shopItem = ShopItem(
